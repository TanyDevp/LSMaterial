(function (window, $) {
    ...
    $.ajax({
        type: 'POST',
        url: posturl + 'SellerCenter/ShowAllReturn',
        data: {
                            ...
                            <div class="order-content">\
                                ...
                                <div class="order-right" style="width: 30%;">\
                                    <div class="move-right">\
                                        ...
                                        <li class="td td-change">\
                                            '+ ((x.IsSellerAgreeReturn == 0 && x.IsRequestReturn == 1) ? '<span><button class="am-btn am-btn-sm am-btn-danger anniu" math="' + tbtn + '">同意退货</button></span>' : '已关闭') + '\
                                        </li>\
                                    </div>\
                                </div>\
                        ...
                        $('button[math="' + tbtn + '"]').click(function () {
                            $('#sure_quRegoods').modal({
                                ...
                                onConfirm: function (e) {
                                    $.ajax({
                                        type: 'POST',
                                        url: posturl + 'SellerCenter/AgreeReturn',
                                        data: {
                                            SessionKey: localStorage.lsid,
                                            ReturnGuid: x.Guid,
                                        },
