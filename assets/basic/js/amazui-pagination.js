...
; (function (window, undefined, $) {
  ...
  Pagination.prototype.render = function (num) {
    ...
    // 如果当前是第一页的话，上一按钮不可用
    num > 1 ?
      template.push('<li data-ruler="prev"><a href="javascript:void(0);">' + prevText + '</a></li>') :
      template.push('<li data-ruler="prev" class="am-disabled"><a href="javascript:void(0);">' + prevText + '</a></li>');

    // 距离第一页页数过长就省略
    if (number3 > base && num + differNumber >= count) {
      template.push('<li><a href="javascript:void(0);">1</a></li>');
      template.push('<li class="am-disabled"><a href="javascript:void(0);">...</a></li>');
    }

    for (var i = number2; i <= number3; i++) {
      num === i ?
        template.push('<li class="am-active"><a href="javascript:void(0);">' + i + '</a></li>') :
        template.push('<li><a href="javascript:void(0);">' + i + '</a></li>');
    }

    // 距离最后一页页数过长就省略
    if (count > base && num + differNumber < count) {
      template.push('<li class="am-disabled"><a href="javascript:void(0);">...</a></li>');
      template.push('<li><a href="javascript:void(0);">' + count + '</a></li>');
    }

    // 如果当前是最后一页的话，下一页按钮不可用
    num === count ?
      template.push('<li data-ruler="next" class="am-disabled"><a href="javascript:void(0);">' + nextText + '</a></li>') :
      template.push('<li data-ruler="next"><a href="javascript:void(0);">' + nextText + '</a></li>');
